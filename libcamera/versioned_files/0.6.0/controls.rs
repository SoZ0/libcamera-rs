...
pub enum ControlId {
    ...
    FrameWallClock = FRAME_WALL_CLOCK,
    /// Set the WDR mode.
    ///
    ...
    WdrMaxBrightPixels = WDR_MAX_BRIGHT_PIXELS,
    ...
    LensDewarpEnable = LENS_DEWARP_ENABLE,
...
/// The FrameWallClock control can only be returned in metadata.
#[derive(Debug, Clone)]
pub struct FrameWallClock(pub i64);
impl Deref for FrameWallClock {
    type Target = i64;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl DerefMut for FrameWallClock {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
impl TryFrom<ControlValue> for FrameWallClock {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<i64>::try_from(value)?))
    }
}
impl From<FrameWallClock> for ControlValue {
    fn from(val: FrameWallClock) -> Self {
        ControlValue::from(val.0)
    }
}
impl ControlEntry for FrameWallClock {
    const ID: u32 = ControlId::FrameWallClock as _;
}
impl Control for FrameWallClock {}
/// Set the WDR mode.
///
/// The WDR mode is used to select the algorithm used for global tone
/// mapping. It will automatically reduce the exposure time of the sensor
...
impl TryFrom<ControlValue> for WdrMode {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Self::try_from(i32::try_from(value.clone())?)
            .map_err(|_| ControlValueError::UnknownVariant(value))
...
impl From<WdrMode> for ControlValue {
    fn from(val: WdrMode) -> Self {
        ControlValue::from(<i32>::from(val))
    }
}
impl ControlEntry for WdrMode {
    const ID: u32 = ControlId::WdrMode as _;
}
impl Control for WdrMode {}
/// Specify the strength of the wdr algorithm. The exact meaning of this
/// value is specific to the algorithm in use. Usually a value of 0 means no
/// global tone mapping is applied. A values of 1 is the default value and
/// the correct value for most scenes. A value above 1 increases the global
/// tone mapping effect and can lead to unrealistic image effects.
#[derive(Debug, Clone)]
pub struct WdrStrength(pub f32);
impl Deref for WdrStrength {
    type Target = f32;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl DerefMut for WdrStrength {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
impl TryFrom<ControlValue> for WdrStrength {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<f32>::try_from(value)?))
    }
}
impl From<WdrStrength> for ControlValue {
    fn from(val: WdrStrength) -> Self {
        ControlValue::from(val.0)
    }
}
impl ControlEntry for WdrStrength {
    const ID: u32 = ControlId::WdrStrength as _;
}
impl Control for WdrStrength {}
/// Percentage of allowed (nearly) saturated pixels. The WDR algorithm
/// reduces the WdrExposureValue until the amount of pixels that are close
/// to saturation is lower than this value.
#[derive(Debug, Clone)]
pub struct WdrMaxBrightPixels(pub f32);
impl Deref for WdrMaxBrightPixels {
    type Target = f32;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl DerefMut for WdrMaxBrightPixels {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
impl TryFrom<ControlValue> for WdrMaxBrightPixels {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<f32>::try_from(value)?))
    }
}
impl From<WdrMaxBrightPixels> for ControlValue {
    fn from(val: WdrMaxBrightPixels) -> Self {
        ControlValue::from(val.0)
    }
}
impl ControlEntry for WdrMaxBrightPixels {
    const ID: u32 = ControlId::WdrMaxBrightPixels as _;
}
impl Control for WdrMaxBrightPixels {}
/// Enable or disable lens dewarping. This control is only available if lens
/// dewarp parameters are configured in the tuning file.
#[derive(Debug, Clone)]
pub struct LensDewarpEnable(pub bool);
impl Deref for LensDewarpEnable {
    type Target = bool;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl DerefMut for LensDewarpEnable {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
impl TryFrom<ControlValue> for LensDewarpEnable {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<bool>::try_from(value)?))
    }
}
impl From<LensDewarpEnable> for ControlValue {
    fn from(val: LensDewarpEnable) -> Self {
        ControlValue::from(val.0)
    }
}
impl ControlEntry for LensDewarpEnable {
    const ID: u32 = ControlId::LensDewarpEnable as _;
}
impl Control for LensDewarpEnable {}
/// Control for AE metering trigger. Currently identical to
/// ANDROID_CONTROL_AE_PRECAPTURE_TRIGGER.
///
/// Whether the camera device will trigger a precapture metering sequence
...
#[cfg(feature = "vendor_rpi")]
impl TryFrom<ControlValue> for SyncMode {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Self::try_from(i32::try_from(value.clone())?)
            .map_err(|_| ControlValueError::UnknownVariant(value))
...
#[cfg(feature = "vendor_rpi")]
impl From<SyncMode> for ControlValue {
    fn from(val: SyncMode) -> Self {
        ControlValue::from(<i32>::from(val))
    }
}
#[cfg(feature = "vendor_rpi")]
impl ControlEntry for SyncMode {
    const ID: u32 = ControlId::SyncMode as _;
}
#[cfg(feature = "vendor_rpi")]
impl Control for SyncMode {}
/// When using the camera synchronisation algorithm, the server broadcasts
/// timing information to the clients. This also includes the time (some
/// number of frames in the future, called the "ready time") at which the
/// server will signal its controlling application, using this control, to
...
#[cfg(feature = "vendor_rpi")]
#[derive(Debug, Clone)]
pub struct SyncReady(pub bool);
#[cfg(feature = "vendor_rpi")]
impl Deref for SyncReady {
    type Target = bool;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[cfg(feature = "vendor_rpi")]
impl DerefMut for SyncReady {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
#[cfg(feature = "vendor_rpi")]
impl TryFrom<ControlValue> for SyncReady {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<bool>::try_from(value)?))
    }
...
#[cfg(feature = "vendor_rpi")]
impl From<SyncReady> for ControlValue {
    fn from(val: SyncReady) -> Self {
        ControlValue::from(val.0)
    }
}
#[cfg(feature = "vendor_rpi")]
impl ControlEntry for SyncReady {
    const ID: u32 = ControlId::SyncReady as _;
}
#[cfg(feature = "vendor_rpi")]
impl Control for SyncReady {}
/// This reports the amount of time, in microseconds, until the "ready
/// time", at which the server and client will signal their controlling
/// applications that the frames are now synchronised and should be
/// used. The value may be refined slightly over time, becoming more precise
...
#[cfg(feature = "vendor_rpi")]
#[derive(Debug, Clone)]
pub struct SyncTimer(pub i64);
#[cfg(feature = "vendor_rpi")]
impl Deref for SyncTimer {
    type Target = i64;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[cfg(feature = "vendor_rpi")]
impl DerefMut for SyncTimer {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
#[cfg(feature = "vendor_rpi")]
impl TryFrom<ControlValue> for SyncTimer {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<i64>::try_from(value)?))
    }
...
#[cfg(feature = "vendor_rpi")]
impl From<SyncTimer> for ControlValue {
    fn from(val: SyncTimer) -> Self {
        ControlValue::from(val.0)
    }
}
#[cfg(feature = "vendor_rpi")]
impl ControlEntry for SyncTimer {
    const ID: u32 = ControlId::SyncTimer as _;
}
#[cfg(feature = "vendor_rpi")]
impl Control for SyncTimer {}
/// The number of frames the server should wait, after enabling
/// SyncModeServer, before signalling (via the SyncReady control) that
/// frames should be used. This therefore determines the "ready time" for
/// all synchronised cameras.
...
#[cfg(feature = "vendor_rpi")]
#[derive(Debug, Clone)]
pub struct SyncFrames(pub i32);
#[cfg(feature = "vendor_rpi")]
impl Deref for SyncFrames {
    type Target = i32;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[cfg(feature = "vendor_rpi")]
impl DerefMut for SyncFrames {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
#[cfg(feature = "vendor_rpi")]
impl TryFrom<ControlValue> for SyncFrames {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<i32>::try_from(value)?))
    }
...
#[cfg(feature = "vendor_rpi")]
impl From<SyncFrames> for ControlValue {
    fn from(val: SyncFrames) -> Self {
        ControlValue::from(val.0)
    }
}
#[cfg(feature = "vendor_rpi")]
impl ControlEntry for SyncFrames {
    const ID: u32 = ControlId::SyncFrames as _;
}
#[cfg(feature = "vendor_rpi")]
impl Control for SyncFrames {}
pub fn make_dyn(
    id: ControlId,
    val: ControlValue,
    ...
    match id {
        ...
        ControlId::FrameWallClock => Ok(Box::new(FrameWallClock::try_from(val)?)),
        ControlId::WdrMode => Ok(Box::new(WdrMode::try_from(val)?)),
        ControlId::WdrStrength => Ok(Box::new(WdrStrength::try_from(val)?)),
        ControlId::WdrMaxBrightPixels => Ok(Box::new(WdrMaxBrightPixels::try_from(val)?)),
        ControlId::LensDewarpEnable => Ok(Box::new(LensDewarpEnable::try_from(val)?)),
        #[cfg(feature = "vendor_draft")]
        ...
        #[cfg(feature = "vendor_rpi")]
        ControlId::SyncMode => Ok(Box::new(SyncMode::try_from(val)?)),
        #[cfg(feature = "vendor_rpi")]
        ControlId::SyncReady => Ok(Box::new(SyncReady::try_from(val)?)),
        #[cfg(feature = "vendor_rpi")]
        ControlId::SyncTimer => Ok(Box::new(SyncTimer::try_from(val)?)),
        #[cfg(feature = "vendor_rpi")]
        ControlId::SyncFrames => Ok(Box::new(SyncFrames::try_from(val)?)),
    }
}
